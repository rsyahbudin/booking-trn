        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center gap-3">
                    <a href="https://wa.me/6285813035292" target="_blank" class="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 dark:bg-white/5 backdrop-blur-md text-zinc-900 dark:text-white hover:bg-green-500 hover:text-white transition-all duration-300 font-medium text-sm group border border-white/20">
                    ...
                    <a href="https://instagram.com/terasrumahnenek" target="_blank" class="flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 dark:bg-white/5 backdrop-blur-md text-zinc-900 dark:text-white hover:bg-pink-500 hover:text-white transition-all duration-300 font-medium text-sm group border border-white/20">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    <p class="text-zinc-400">Kami menyediakan kebersamaan, keramahan, dan suasana nyaman, sebagai pengingat kembali pulang sejauh apapun berjuang. <br>Mari pulang, mari membuka ruang.</p>
                </div>
                <div>
                    ...
                    <ul class="space-y-2 text-zinc-400">
                        <li class="flex items-center gap-2">
                            ...
                            <span>+62 858-1303-5292</span>
                        </li>
                        <li class="flex items-center gap-2">
                            <svg class="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                            <span>Jl. Abdulrahman No.46, RT.12/RW.5, Cibubur, Kec. Ciracas, Kota Jakarta Timur</span>
                        </li>
                    </ul>
                </div>
                <div>
