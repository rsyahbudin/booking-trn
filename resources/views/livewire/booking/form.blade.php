                ...
                <div x-data="{ showRules: false }" class="space-y-6 animate-fade-in max-w-5xl mx-auto">
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-6 space-y-4 md:space-y-0">
                        ...
                        <div class="relative md:col-span-2">
                            <input type="text" wire:model="customer_name" id="customer_name" class="peer w-full px-4 pt-5 pb-2 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white focus:ring-2 focus:ring-amber-500 focus:border-transparent placeholder-transparent transition shadow-sm" placeholder="Nama Lengkap">
